...
Route::prefix('events')->group(function() {
    ...
    Route::post('/update/{event_id}', 'App\Http\Controllers\EventsController@update'); // Update event by its id
    Route::delete('/delete/{event_id}', 'App\Http\Controllers\EventsController@destroy'); // Delete event by its id
});
Route::prefix('subs')->group(function() {
    ...
    Route::get('/organizer/{event_id}', 'App\Http\Controllers\SubscriptionsController@showOrganizerEvents'); // Show all ogganizers event by event id
    Route::get('/my', 'App\Http\Controllers\SubscriptionsController@showMySubs'); // Show user subs using his token
    Route::delete('/delete/{event_id}', 'App\Http\Controllers\SubscriptionsController@unsubscribeFromEvent'); // Delete subscription by event id
});
Route::prefix('comments')->group(function() {
    ...
    Route::delete('/delete/{id}', 'App\Http\Controllers\CommentsController@destroy'); //Delete comment by its id
});
Route::prefix('users')->group(function() {
    ...
    Route::post('/update/{id}', 'App\Http\Controllers\UsersController@update'); // Update user by its id
    Route::delete('/delete/{id}', 'App\Http\Controllers\UsersController@destroy'); //Delete user by its id
});
